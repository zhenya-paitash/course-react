...
router.post('/', 
  ...
  async (req, res) => {
    ...
    if (linkedin) profileFields.social.status = linkedin;
...
router.delete('/experience/:exp_id', auth, async (req, res) => {
  try {
    ...
    // Get remove index & delete it
    const removeIdx = profile.experience.map(i => i.id).indexOf(req.params.exp_id);
...
router.delete('/education/:edu_id', auth, async (req, res) => {
  try {
    ...
    // Get remove index & delete it
    const removeIdx = profile.education.map(i => i.id).indexOf(req.params.edu_id);
